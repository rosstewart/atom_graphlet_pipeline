...
def svml_to_sparse(save_dir, graphlet_idx_mapping_f):
    ...
    with open(graphlet_idx_mapping_f,'rb') as f:
...
def run_svm_inference(pdb_id, save_dir, model_path):
    sparse_dir = save_dir
    graph_dir = save_dir
